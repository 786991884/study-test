...
import com.xubh.http.common.HttpConfig;
import com.xubh.http.common.HttpHeader;
import com.xubh.http.exception.HttpProcessException;
import com.xubh.http.httpclient.HttpAsyncClientUtil;
import com.xubh.http.httpclient.builder.HACB;
...
public class HttpAsyncClientTest {
    ...
    public static void testOne() throws HttpProcessException {
        ...
        //设置header信息
        Header[] headers = HttpHeader.custom().keepAlive("false").contentType(HttpHeader.Headers.APP_FORM_URLENCODED).build();
        //执行
