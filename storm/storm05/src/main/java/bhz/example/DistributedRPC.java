...
public class DistributedRPC {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length == 0) {
            ...
            Thread.sleep(2000);
            DRPCClient client = new DRPCClient(null, "RRPC-Server", 1234);
    ...
    public static StormTopology buildTopology(LocalDRPC drpc) {
        ...
        TridentState countryCount = topology.newStream("faketweetspout", (IRichSpout) spout)
                .shuffle()
                .each(new Fields("text", "Country"), (Filter) new TridentUtility.TweetFilter()).groupBy(new Fields("Country"))
        ...
        topology.newDRPCStream("Count", drpc)
                .each(new Fields("args"), (Function) new TridentUtility.Split(), new Fields("Country"))
