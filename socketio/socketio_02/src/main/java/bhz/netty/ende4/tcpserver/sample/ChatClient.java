package bhz.netty.ende4.tcpserver.sample;
...
//                                .addLast("frameEncode", new ProtobufVarint32LengthFieldPrepender())
    ...
    public static class ChatClientHandler extends ChannelHandlerAdapter {
        // 接收server端的消息，并打印出来
        @Override
        public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
            if (msg instanceof ClientServerMsg.Rsp) {
                ClientServerMsg.Rsp rsp = (ClientServerMsg.Rsp) msg;
                if (rsp.getType().equals(MsgTypeConstant.LOGIN)) {
